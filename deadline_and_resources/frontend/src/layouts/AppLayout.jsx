...
export default function AppLayout() {
  ...
  const submitHelpRequest = async () => {
    try {
      ...
      await api.createHelpRequest({
        type: helpType,
        description: helpDesc?.trim() || '(no description)',
        urgency,
      })
      setHelpOpen(false)
      setHelpDesc('')
      ...
      alert(e?.message || 'Failed to submit help request')
    }
  }
  ...
  return (
    <div className="app-container">
      <div className="navbar">
        <div className="nav-container">
          <div className="nav-brand">
            <span>SAPPHIRE</span>
            <small style={{ marginLeft: 8, fontSize: '0.8rem', opacity: 0.8 }}>
              Deadlines & Resources
            </small>
          </div>

          <div className="nav-links">
            <NavLink to="/deadlines" className={linkClass}>
          ...
          <div className="modal-body">
            ...
            <div className="help-options">
              {[
                ...
                <button
                  key={label}
                  className="help-option-btn"
                  onClick={() => setHelpType(label)}
                  aria-pressed={helpType === label}
                >
            ...
            <div className="form-group">
              <label className="form-label" htmlFor="helpDesc">
              ...
              <div className="urgency-options">
                ...
                <label>
                  <input
                    ...
                    value="high"
                  />
                  <span className="urgency-badge high">High</span>
                </label>
              </div>
            </div>
          </div>
          <div className="modal-footer">
            <button className="btn btn--outline" onClick={closeHelpModal}>
              Cancel
            </button>
            <button className="btn btn--primary" onClick={submitHelpRequest}>
              Submit Request
            </button>
          </div>
        </Modal>
      ...
      <div
        className={`notification ${notify ? '' : 'hidden'}`}
